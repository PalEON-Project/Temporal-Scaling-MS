...
fig.dir <- file.path(fig.base, "TPC_YR_byResolution")
dat.dir <- file.path(dat.base, "TPC_YR_byResolution")
...
pdf(file.path(fig.dir, paste0("GAMM_ResponsePrediction_TPC_GS_", m.order, "_", response, ".pdf")))
print(
...
pdf(file.path(fig.dir, paste0("GAMM_DriverEffects_TPC_GS_", m.order, "_", response, ".pdf")))
print(
