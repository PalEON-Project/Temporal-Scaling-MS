...
models.base <- mclapply(paleon.models, paleon.gamms.models, mc.cores=length(paleon.models), response=response, k=3, predictors.all=predictors.all)


# Run all the saving etc
for(m in 1:length(model.name)){
