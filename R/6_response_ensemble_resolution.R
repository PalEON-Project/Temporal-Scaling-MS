...
path.data <- "Data"
in.base <- "Data/gamms/Sensitivity_All_TempRes"
...
load(file.path(in.base, "gamm_Models_NPP_Resolutions_ExtentFull.Rdata"))
...
pdf(file.path(fig.dir, "NPP_Sensitivity_Models_Raw_Resolution.pdf"), height=8.5, width=11)
# png(file.path(fig.dir, "NPP_Sensitivity_Models_Raw_NoSite.png"))
print(
ggplot(data=ci.terms) + facet_grid(Resolution~Effect, scales="free_x") +
...
pdf(file.path(fig.dir, "NPP_Sensitivity_Models_Rel_Res.pdf"), height=8.5, width=11)
print(
ggplot(data=ci.terms.graph) + facet_grid(Resolution~Effect, scales="free_x") +
