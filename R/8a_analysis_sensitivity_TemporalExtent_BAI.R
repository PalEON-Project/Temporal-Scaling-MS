...
# setwd("..")
path.data <- "Data"
in.base <- "Data/gamms/Sensitivity_TempExtent_BAI"
out.dir <- "Data/analyses/analysis_TempExtent_BAI"
fig.dir <- "Figures/analyses/analysis_TempExtent_BAI"
...
pdf(file.path(fig.dir, "Sensitivity_Rel_Extent_AllExtents_BAI.pdf"), height=8.5, width=11)
{
models.df <- data.frame(Model=unique(dat.ecosys[,"Model"]), Model.Order=unique(dat.ecosys[,"Model.Order"]))
colors.use <- as.vector(c(paste(model.colors[model.colors$Model.Order %in% models.df$Model.Order, "color"]), "black", "gray30"))
print(
...
pdf(file.path(fig.dir, "Sensitivity_Rel_Extent_Biomass_BAI.pdf"), height=11, width=8.5)
{
print(
...
png(file.path(fig.dir, "Fig3_Sensitivity_Rel_extent_BAI.png"), width=8, height=6, units="in", res=120)
grid.newpage()
