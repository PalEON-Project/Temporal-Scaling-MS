...
ggplot() + facet_grid(Data.Type ~ Site, scales="free", space="free") +
	scale_x_continuous(limits=c(1900,2010), expand=c(0,0), breaks=c(1800, 1850, 1900, 1950, 2000)) +
 	geom_ribbon(data= ensemble.wts.site[!ensemble.wts.site$Data.Type=="TreeRingNPP",], aes(x=Year, ymin=Y.rel.10.lo*100, ymax=Y.rel.10.hi*100), alpha=0.5) +
	geom_line(data= ensemble.wts.site[ensemble.wts.site$Site=="PHO" & ensemble.wts.site$Data.Type=="TreeRingRWI",], aes(x=Year, y=Y.rel.10*100),
	          color=rgb(abs(ensemble.wts.site[ensemble.wts.site$Site=="PHO"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.tair.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PHO"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.CO2.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PHO"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.precipf.10"])), size=4) +
	geom_line(data= ensemble.wts.site[ensemble.wts.site$Site=="PHA" & ensemble.wts.site$Data.Type=="TreeRingRWI",], aes(x=Year, y=Y.rel.10*100),
	          color=rgb(abs(ensemble.wts.site[ensemble.wts.site$Site=="PHA"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.tair.10"]),
                        ...
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PHA"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.precipf.10"])), size=4) +
	geom_line(data= ensemble.wts.site[ensemble.wts.site$Site=="PUN" & ensemble.wts.site$Data.Type=="TreeRingRWI",], aes(x=Year, y=Y.rel.10*100),
	          color=rgb(abs(ensemble.wts.site[ensemble.wts.site$Site=="PUN"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.tair.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PUN"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.CO2.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PUN"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.precipf.10"])), size=4) +
	geom_line(data= ensemble.wts.site[ensemble.wts.site$Site=="PBL" & ensemble.wts.site$Data.Type=="TreeRingRWI",], aes(x=Year, y=Y.rel.10*100),
	          color=rgb(abs(ensemble.wts.site[ensemble.wts.site$Site=="PBL"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.tair.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PBL"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.CO2.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PBL"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.precipf.10"])), size=4)	+
	geom_line(data= ensemble.wts.site[ensemble.wts.site$Site=="PDL" & ensemble.wts.site$Data.Type=="TreeRingRWI",], aes(x=Year, y=Y.rel.10*100),
	          color=rgb(abs(ensemble.wts.site[ensemble.wts.site$Site=="PDL"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.tair.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PDL"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.CO2.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PDL"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.precipf.10"])), size=4)	+                        
	geom_line(data= ensemble.wts.site[ensemble.wts.site$Site=="PMB" & ensemble.wts.site$Data.Type=="TreeRingRWI",], aes(x=Year, y=Y.rel.10*100),
	          color=rgb(abs(ensemble.wts.site[ensemble.wts.site$Site=="PMB"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.tair.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PMB"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.CO2.10"]),
                        abs(ensemble.wts.site[ensemble.wts.site$Site=="PMB"& ensemble.wts.site$Data.Type=="TreeRingRWI","weight.precipf.10"])), size=4)	+
