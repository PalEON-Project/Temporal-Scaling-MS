...
path.data <- "Data"
in.base <- "Data/gamms/Sensitivity_Baseline_BAI"
out.dir <- "Data/analyses/analysis_baseline_BAI"
fig.dir <- "Figures/analyses/analysis_baseline_BAI"
...
pdf(file.path(fig.dir, "Sensitivity_Models_Rel_Baseline_BAI.pdf"), height=8.5, width=11)
{
print(
...
png(file.path(fig.dir, "Sensitivity_Models_Rel_Baseline_Climate_BAI.png"), height=8, width=10, units="in", res=180)
{
  print(
